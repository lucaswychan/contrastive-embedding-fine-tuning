...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, embeddings, terminology_labels):
        ...
        labels_matrix = terminology_labels.unsqueeze(0) == terminology_labels.unsqueeze(1)
        ...
        positive_pairs = similarity_matrix[labels_matrix.bool()].reshape(embeddings.shape[0], -1)
